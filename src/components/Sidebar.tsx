...
import { Home, FileText, Users, Receipt, Settings, Globe, LogOut, Moon, Sun, ChevronDown } from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  const menuItems = React.useMemo(() => [
    ...
    { path: '/receipts', label: t('receipts'), icon: Receipt },
    { path: '/account', label: t('account'), icon: Users },
  ], [t]);
              ...
              <AnimatePresence>
                {showLanguageMenu && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="absolute right-0 top-full mt-2 w-80 bg-white/10 backdrop-blur-xl border border-white/10 rounded-xl shadow-lg overflow-hidden p-2"
                  >
